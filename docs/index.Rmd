...
.pull-top[
<p style="font-weight:bold;"> Parte 1 - Fundamentação teórica </p>
...
.blockquote[
**Motivos para fazer uma análise de regressão...** `r Citep(myBib, "izbicki_mendonca2020")` <br>

- **Inferencial**: Tirar conclusões sobre a população:
  - Interpretar parâmetros;
  - Estimar intervalos de confiança (IC) dos parâmetros; e
  - Testes de hipóteses (normalidade, homocedasticidade dos resíduos, etc.) $\Rightarrow$ .content-box-red[Suposições da RL]


- **Preditivista**: Foco na capacidade preditiva. Deseja-se boas predições!
]
...
.blockquote[
**Culturas de modelagem...** 

Data modeling culture
- Objetivo principal: interpretação dos parâmetros 
