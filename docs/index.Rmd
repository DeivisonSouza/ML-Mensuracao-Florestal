...
```
**cp** = parâmetro custo-complexidade.

**minsplit** = número mínimo de obs. p/ tentar uma divisão.
]
]
...
<!-- Slide XX -->
---
# Métodos de Reamostragem: qual escolher?

**Não existe uma resposta fechada...**

.pull-left-6[
.blockquote[
**Mas, teria alguns direcionamentos:**

<br>**1 -** **Prefira o k-fold cross validation** (simples ou repetido) ou **LOOCV** ao invés de hold-out, pois são melhores estimadores do erro de generalização do que Hold-out validation.

<br>**2 -** Pondere sobre o **tamanho da base** de dados e a **quantidade de hiperparâmetros** a serem ajustados (depende do algoritmo).

<br>**a)** **LOOCV** é mais razoável para bases de dados de **menor porte** e para ajustar modelos com **poucos hiperparâmetros**. Isto porque, o método possui naturalmente um maior custo computacional.

<br>**b)** **k-fold CV** é mais razoável para bases de dados de **médio a grande porte**, e quando existem **muitos hiperparâmetros** para ajustar.
]
]

.pull-right-8[
Obs.: Obviamente, a decisão também depende da capacidade computacional que você têm disponível...
]
...
<!-- <br>**Aprendizado de Máquina**: **foco** principal é a **predição**. -->

<!-- Na maioria das vezes, modelos extremamente complexos são aprendidos, em geral, com alto poder preditivo. -->

<!-- <br>**Dilema**: $\Uparrow$ complexidade x $\Downarrow$ interpretabilidade  -->


<!-- <br> **Ah, então não é possível extrair explicações do tipo:** -->

<!-- - Qual a importância relativa de preditoras para o modelo preditivo? -->

<!-- - Qual a relação (ou efeito) marginal entre resposta-preditor no modelo? -->

<!-- <br> **Sim, é possível! Já existem alguns métodos e frameworks desenvolvidos...** -->
...
.font200[Aplicação Web: MAM para biomassa e volume]

.pull-left[
Como disponibilizar os modelos de aprendizado de máquina?

.font80[
**Shiny**: Biblioteca que facilita a criação de aplicativos da Web interativos usando diretamente a Linguagem R.

**Shinyapps.io**: Servidor gratuito para hospedar os aplicativos Shiny.
]

Acesse as aplicações web desenvolvidas por Souza (2020):
...
Acesse a base para uso na aplicação MLMBio: [Biomass-data](https://deivisonsouza.github.io/ML-Mensuracao-Florestal/R-scripts/data.csv)
...
.font200[**Parte 3** <br> .green[Aplicações nas ciências florestais]
]
...
---
name: ammt
# AM vs Métodos Tradicionais: Volume
...
<!--Slide XX -->
---
# AM vs Métodos Tradicionais: Altura
...
MAM têm mostrado competitividade, em termos de desempenho preditivo, frente aos métodos tradicionais.
...
c) Nestes casos (item b), usar o **princípio da parcimônia** (escolher o modelo mais simples) parece ser mais plausível.
]
...
<br>a) Algumas pesquisas consideram **apenas o uso de covariáveis tradicionais** para ajustar MAM. Por exemplo: $v = f(D,H)$
...
.center[.font150[**Relexões para pesquisas futuras usando AM...**]]

.blockquote[
<br>**1 - Novas preditoras + Diferentes algoritmos**

<br>Ponderar **diferentes abordagem de AM** e refletir **novas variáveis preditoras** parece ser um bom caminho a seguir na buscar por modelos mais acurados.

- **Dificuldades**: 

É preciso identificar essas variáveis.

É preciso ponderar o custo (prático e financeiro) de determinação em campo.

É preciso compreender os algoritmos e seus hiperparâmetros para não falhar no procedimento de ajuste.

<br> .center[**Em florestais inequiâneas tudo é mais difícil, oneroso,...!**]
...
.blockquote[
<br>**2 - Unindo forças: Métodos tradicionais + Aprendizado de Máquina**

<br>**Ao contrário de buscar superar Schumacher-Hall, por que não unir forças!?**

<br> Usando o conhecimento de domínio...

<br>**Árvores Modelos (M5')**: Modificar o algoritmo M5' para considerar modelos tradicionais nos nós terminais?

- **Dificuldades**: programação + matemática subjacente
