...
<!--Slide 15 -->
---
# Regression Tree: Um modelo CART...

.panelset[
.panel[.panel-name[Dados]
.scroll-box-20[
```{r panel-chunk, fig.show='hide', echo=FALSE, eval=TRUE, message=FALSE}
library(kableExtra)
data <- data.table::fread("R-scripts/Cedrela.csv")
...
```{r, echo=FALSE, fig.width=5, fig.height=2, fig.align='center', fig.cap='Árvore CART (rpart/cp = 0)', dpi=600, eval=TRUE, message=FALSE}
set.seed(1)
tree <- rpart(V ~ ., data = data, method="anova", 
