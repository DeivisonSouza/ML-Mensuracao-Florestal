...
[1 - Aprendizado de Máquina com linguagem R](#AMLR)

[2 - Pacote CARET](#caret)

[3 - Aprendizado de Máquina no R: exemplo prático](#exemploR)

[4 - Aplicação Web com MAM: demonstração.](#shiny)
...
.center[.font150[**Percepções e reflexões para Mensuração Florestal**]]
<br>
...
**2 - Superioridade**: Existem relatos de maior acurácia para modelos de AM frente à RL. Mas, muitas vezes os **ganhos de acurácia não parecem ser expressivos**.
...
**4 - Covariáveis tradicionais**: Usar apenas as covariáveis tradicionais (ex.: D e H para modelar o volume) para estimar modelos de AM parece não produzir resultados extremamente superiores do que os métodos tradicionais (ex.: Schumacher-Hall).

<!--Slide XX -->
---
# Considerações finais

.center[.font150[**Pesquisas futuras**]]

1) Reflexão de novas preditoras para melhoria da acurácia
