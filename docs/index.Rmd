...
.pull-left[
```{r, echo=FALSE, fig.width=5, fig.height=3, fig.align='center', fig.cap='Árvore CART (rpart/cp = 0/minsplit = 20)', dpi=600, eval=TRUE, message=FALSE}
set.seed(1)
data2 <- data %>% select(-Arvore)
