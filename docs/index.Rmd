...
a) Em cada nó de decisão, selecionar um subconjunto aleatório de preditores, $p$;

b) A melhor divisão será escolhida dentre os $p$ preditores candidatos.
...
randomForest(V ~ D + H, 
             data = data,
             ntree = 10,       # número de árvores
             mtry = FALSE,     # número de preditoras
             maxnodes = NULL,
