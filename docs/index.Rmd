...
[2 - Culturas no uso de modelos estatísticos](#CultME)

[3 - Aprendizado de Máquina](#AM)

[4 - Tipos de Aprendizagem](#TA)

[5 - Algoritmos de Aprendizado Supersivionado](#AAS)
...
.font200[**Culturas no uso de <br> modelos estatísticos**]
...
---
# Minimizar overfitting: Parada antecipada
...
for(i in maxdepth) {
 ...
 predictions <- mutate(bio, maxdepth = maxdepth[i])
 predictions$pred <- predict(fit, bio)
