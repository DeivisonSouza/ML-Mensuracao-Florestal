...
---
# Regression Tree (CART) - Características gerais
...
Realizar particionamentos recursivos no espaço das covariáveis
...
- Depois de falar sobre todos os algoritmos entrar em: "Seleção de Modelos"....
