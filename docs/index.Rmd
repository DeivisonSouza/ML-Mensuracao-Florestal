...
- Fornece uma estimativa de alta variação.
- O erro de predição no conjunto de validação pode mudar muito, dependendo de qual observação seja aleatorizada no conjunto de validação.
]
...
**1** - Dividir o conjunto de treinamento em k partições iguais e disjuntas; (Recomendação: 5 ou 10);
...
**2** - Usar k-1 partições para treinar o modelo e avaliar na partição que ficou de fora.
  ...
  - Conjunto de treinamento: 9 partições (63 observações); e
  - Conjunto de validação: 1 partição (7 observações).
