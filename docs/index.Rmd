...
- **Tipos de problemas**: classificação e regressão.
  - **Classificação**: variável resposta é uma categoria/classe. (Ex.: species recognition)
  - **Regressão**: variável resposta é um valor real (numérica). (Ex.: biomassa, volume, altura, etc.)
  - **Objetivo principal**: Estimar uma função $f(x)$ para predizer a variável resposta em novos conjuntos de dados.
