...
# Olá, seja bem vindo(a)! :deciduous_tree: :smiley: :grin:
...
O slide da palestra assíncrona intitulada **"Aprendizado de Máquina na Mensuração Florestal: Técnicas, Modelagem e Aplicação Web"** está disponível a seguir.
